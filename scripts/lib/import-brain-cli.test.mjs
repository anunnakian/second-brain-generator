...
test("parseArgs — positional is the source, --apply is a flag", () => {
  assert.deepEqual(parseArgs(["/old/brain"]), { source: "/old/brain", apply: false });
  assert.deepEqual(parseArgs(["/old/brain", "--apply"]), { source: "/old/brain", apply: true });
  assert.deepEqual(parseArgs(["--apply", "/old/brain"]), { source: "/old/brain", apply: true });
});
