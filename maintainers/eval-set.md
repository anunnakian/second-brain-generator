...
> plan](plans/prospective/rag-embedder-plan-action.md): it turns "is this embedder good?" into a
> **reproducible numeric score**. It establishes the **Gemini baseline**; in [Step 4](plans/prospective/rag-embedder-plan-action.md#step-4--wire-up-local--measure-vs-gemini-),
